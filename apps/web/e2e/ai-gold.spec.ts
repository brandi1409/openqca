...
test("policy gate blocks paraphrases and permits bounded explanations", () => {
  const unsafe: Array<[AiPolicyCode, string]> = [
    ...
    ["numeric-qca", "Set membership to 0.75."],
    ["numeric-qca", "We set membership to 0.75."],
    ["role-selection", "Choose this variable as the outcome."],
    ["role-selection", "Wähle diese Variable als Bedingung."],
    ["role-selection", "Treat income as the outcome."],
    ["role-selection", "Klassifiziere Einkommen als Ergebnis."],
    ["role-selection", "Assign income as the outcome."],
    ["role-selection", "Designate income as the outcome."],
    ["role-selection", "Weise Einkommen als Ergebnis zu."],
    ["citation-or-source", "Smith (2024) supports this definition."],
    ["citation-or-source", "Müller 2024 stützt diese Definition."],
    ["citation-or-source", "Smith’s 2024 study supports this definition."],
    ["citation-or-source", "Smith [2024] supports this definition."],
    ...
    ["causal-claim", "Funding leads to resilience."],
    ["causal-claim", "Förderung führt zur Resilienz."],
    ["causal-claim", "Funding increases resilience."],
    ["causal-claim", "Förderung erhöht die Resilienz."],
    ["causal-claim", "Funding enables resilience."],
    ["causal-claim", "Förderung ermöglicht Resilienz."],
  ...
  for (const rationale of [
    ...
    "The current choice is 0.8.",
    "Unsere aktuelle Entscheidung liegt bei 0,8.",
  ]) {
    expect(
      evaluateAiReviewResponse(
        {
  ...
  const safe = [
    ...
    "Der Untersuchungszeitraum reicht von Mai 2024 bis Juni 2025.",
    "Der Zeitraum beginnt Mär 2024 und endet Okt 2025.",
    "Der Zeitraum beginnt Mrz 2024.",
    ...
    "Funding does not lead to resilience.",
