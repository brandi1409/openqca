...
"calib.badOrder": "Anker müssen in Richtung der Zugehörigkeit geordnet sein: voll draußen < Kreuzung < voll drinnen (bei invertierter Skala mit absteigenden Rohwerten).",
  ...
  "workspace.calibration.lede":
    "Methode und Anker je Set festlegen — schnell für den Überblick, dokumentiert für die Publikation.",
  "workspace.calibration.modeAria": "Kalibrierungsmodus",
  "workspace.calibration.sideAria": "Kalibrierungsstand und nächste Aktion",
  "workspace.calibration.statusTitle": "Stand der Sets",
  "workspace.calibration.computable": "{done} von {total} berechenbar",
  "workspace.calibration.reviewed": "{done} von {total} fallgeprüft",
  "workspace.calibration.nextTitle": "Nächste Aktion",
  "workspace.calibration.nextSet": "Set {column} vervollständigen",
  "workspace.calibration.allDone": "Alle Sets sind bestätigt und belegt.",
  "workspace.calibration.noActiveSets": "Wählen Sie mindestens ein aktives Bedingungs- oder Outcome-Set.",
  "workspace.journey.aria": "Entscheidungsweg",
  "workspace.journey.title": "Entscheidungsweg",
  "workspace.journey.design": "Design & Rollen",
  "workspace.journey.calibration": "Kalibrierung",
  "workspace.journey.review": "Fallprüfung & Evidenz",
  "workspace.journey.thresholds": "Analyse-Schwellen",
  "workspace.journey.done": "abgeschlossen",
  "workspace.journey.open": "offen",
  "workspace.journey.current": "aktuell",
  "workspace.journey.design.ready": "Forschungsfrage und Rollen bestätigt",
  "workspace.journey.design.open": "Forschungsfrage und Rollen noch offen",
  "workspace.journey.calibration.detail": "{done} von {total} Sets berechenbar",
  "workspace.journey.review.detail": "{done} von {total} Sets belegt und fallgeprüft",
  "workspace.journey.thresholds.detail": "{done} von {total} Entscheidungen bestätigt",
  "workspace.journey.action.calibration": "Kalibrierung öffnen",
  "workspace.journey.action.review": "Evidenzprüfung öffnen",
  "workspace.journey.action.thresholds": "Schwellen begründen",
  "workspace.journey.allDone":
  ...
  "workspace.answer.incompleteCalibration": "Aktive Kalibrierungen sind unvollständig: {columns}. Ergänzen Sie die fehlenden Angaben unter Entscheidungen.",
  "workspace.answer.calculationFailed": "Die Truth Table konnte unter dem aktuellen Analysestand nicht berechnet werden. Prüfen Sie Daten und Entscheidungen.",
...
"calib.badOrder": "Anchors must follow membership direction: fully out < crossover < fully in (descending raw values for an inverted scale).",
  ...
  "workspace.calibration.lede":
    "Set the method and anchors for each set — quick for orientation, documented for publication.",
  "workspace.calibration.modeAria": "Calibration mode",
  "workspace.calibration.sideAria": "Calibration status and next action",
  "workspace.calibration.statusTitle": "Set status",
  "workspace.calibration.computable": "{done} of {total} computable",
  "workspace.calibration.reviewed": "{done} of {total} case-reviewed",
  "workspace.calibration.nextTitle": "Next action",
  "workspace.calibration.nextSet": "Complete set {column}",
  "workspace.calibration.allDone": "All sets are confirmed and evidenced.",
  "workspace.calibration.noActiveSets": "Select at least one active condition or outcome set.",
  "workspace.journey.aria": "Decision journey",
  "workspace.journey.title": "Decision journey",
  "workspace.journey.design": "Design & roles",
  "workspace.journey.calibration": "Calibration",
  "workspace.journey.review": "Case & evidence review",
  "workspace.journey.thresholds": "Analysis thresholds",
  "workspace.journey.done": "complete",
  "workspace.journey.open": "open",
  "workspace.journey.current": "current",
  "workspace.journey.design.ready": "Research question and roles confirmed",
  "workspace.journey.design.open": "Research question and roles still open",
  "workspace.journey.calibration.detail": "{done} of {total} sets computable",
  "workspace.journey.review.detail": "{done} of {total} sets evidenced and case-reviewed",
  "workspace.journey.thresholds.detail": "{done} of {total} decisions confirmed",
  "workspace.journey.action.calibration": "Open calibration",
  "workspace.journey.action.review": "Open evidence review",
  "workspace.journey.action.thresholds": "Justify thresholds",
  "workspace.journey.allDone":
    "All stages complete — evidence and the defense pack compute with these decisions.",
  ...
  "workspace.answer.incompleteCalibration": "Active calibrations are incomplete: {columns}. Complete the missing information in Decisions.",
  "workspace.answer.calculationFailed": "The truth table could not be computed from the current analysis state. Check the data and decisions.",
